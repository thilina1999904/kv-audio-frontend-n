    ...
    <div className="w-full min-h-screen bg-[var(--color-primary)] py-6 md:py-10 px-4 md:px-10 max-w-[1400px] m-auto">
      ...
      {lodingStatus === "loading" && (
        <div className="w-full h-[60vh] flex flex-col justify-center items-center">
          ...
          <p className="mt-4 text-[var(--color-accent)] font-medium italic">
            Fetching details...
          </p>
        </div>
      )}
      ...
      {lodingStatus === "loaded" && (
        <div className="max-w-[1200px] mx-auto bg-white rounded-[2rem] md:rounded-[3rem] shadow-2xl border border-gray-50 overflow-hidden flex flex-col md:flex-row">
          ...
          <div className="w-full md:w-1/2 bg-[var(--color-secondary)]/10 p-4 md:p-10 flex items-center justify-center">
            ...
            {/* ⭐ CENTERING FIX HERE */}
            <div className="w-full max-w-[500px] min-h-[260px] sm:min-h-[350px] md:min-h-full rounded-2xl shadow-inner bg-white flex flex-col items-center justify-center">
          ...
          {/* Details */}
          <div className="w-full md:w-1/2 p-5 sm:p-6 md:p-12 lg:p-16 flex flex-col">
            {/* Category */}
            <div className="mb-3">
            ...
            {/* Title */}
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-gray-800 mb-4 leading-tight">
              {product.name}
            </h1>

            {/* Description */}
            <div className="bg-gray-50 p-4 sm:p-5 rounded-2xl mb-6 border border-gray-100">
              <h3 className="text-[var(--color-accent)] font-bold text-xs mb-1 uppercase tracking-wider">
                Product Info
              </h3>
            ...
            {/* Price & Button */}
            <div className="mt-auto pt-4 sm:pt-6 border-t border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-4">
              ...
              <button
                ...
                className="w-full sm:w-auto flex items-center justify-center gap-3 bg-[var(--color-accent)] hover:bg-[#1a4d80] text-white font-black px-6 sm:px-8 py-4 rounded-2xl shadow-lg hover:shadow-[var(--color-accent)]/40 transition-all active:scale-95"
              >
